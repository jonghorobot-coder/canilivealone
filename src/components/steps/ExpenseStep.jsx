...
const CATEGORY_ICONS = {
  housing: (
    <svg className="size-responsive-icon-sm text-[#0F3D2E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function ExpenseStep() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/20 animate-stagger animate-stagger-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4 sm:gap-6">
            <div>
              <span className="text-responsive-sm text-white/50 block mb-1 font-medium">수입</span>
              <span className="text-responsive-2xl font-bold text-white tabular-nums">
                {incomeNum.toLocaleString()}<span className="text-responsive-base text-white/50 ml-1 font-normal">만원</span>
              </span>
            </div>
            <div className="h-10 sm:h-12 border-l border-white/20" />
            <div>
              <span className="text-responsive-sm text-white/50 block mb-1 font-medium">지출</span>
              <span className="text-responsive-2xl font-bold text-white tabular-nums">
                {totalExpenses.toLocaleString()}<span className="text-responsive-base text-white/50 ml-1 font-normal">만원</span>
              </span>
            </div>
          </div>
          <div className="text-right">
            <span className="text-responsive-sm text-white/50 block mb-1 font-medium">잔액</span>
            <span className={`text-responsive-3xl font-bold tabular-nums ${
              balance >= 0 ? 'text-[#6EE7B7]' : 'text-[#FCA5A5]'
            }`}>
              {balance >= 0 ? '+' : ''}{balance.toLocaleString()}<span className="text-responsive-base ml-1 font-normal">만원</span>
            </span>
          </div>
        </div>
      </div>
      ...
      {/* 수입 입력 카드 */}
      <div className="bg-white rounded-3xl shadow-sm border border-neutral-100 p-5 sm:p-6 animate-stagger animate-stagger-3">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-responsive-lg font-bold text-neutral-800 tracking-tight">월 수입</p>
            <p className="text-responsive-base text-neutral-400 mt-0.5 sm:mt-1">세후 실수령액</p>
          </div>
